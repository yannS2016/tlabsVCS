...
/* Generated from ../O.Common/vcs.dbd */
...
{
    const char *bldTop = "/epics/ethercat-4-3/iocs/iocvcs";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"vcs_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    vcs_registerRecordDeviceDriver(*iocshPpdbbase);
}
