...
/* Generated from ../O.Common/iocvcs.dbd */
...
int iocvcs_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/tlabsVCS/iocvcs";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"iocvcs_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    iocvcs_registerRecordDeviceDriver(*iocshPpdbbase);
}
