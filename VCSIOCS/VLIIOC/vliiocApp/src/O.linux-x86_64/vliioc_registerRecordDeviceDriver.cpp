...
/* Generated from ../O.Common/vliioc.dbd */
...
int vliioc_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/vcs/VCS/VCSIOCS/VLIIOC";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"vliioc_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    vliioc_registerRecordDeviceDriver(*iocshPpdbbase);
}
