...
#define xxxRecordLCNT	32
#define xxxRecordPACT	33
#define xxxRecordPUTF	26
#define xxxRecordRPRO	27
#define xxxRecordASP	28
#define xxxRecordPPN	29
#define xxxRecordPPNR	32
#define xxxRecordSPVT	33
...
static int xxxRecordSizeOffset(dbRecordType *pdbRecordType)
{
  ...
  pdbRecordType->papFldDes[32]->size=sizeof(prec->lcnt);
  pdbRecordType->papFldDes[32]->offset=(short)((char *)&prec->lcnt - (char *)prec);
  pdbRecordType->papFldDes[33]->size=sizeof(prec->pact);
  pdbRecordType->papFldDes[33]->offset=(short)((char *)&prec->pact - (char *)prec);
  ...
  pdbRecordType->papFldDes[32]->size=sizeof(prec->ppnr);
  pdbRecordType->papFldDes[32]->offset=(short)((char *)&prec->ppnr - (char *)prec);
  pdbRecordType->papFldDes[33]->size=sizeof(prec->spvt);
  pdbRecordType->papFldDes[33]->offset=(short)((char *)&prec->spvt - (char *)prec);
