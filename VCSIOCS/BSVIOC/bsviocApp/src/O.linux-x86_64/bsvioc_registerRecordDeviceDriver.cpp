...
/* Generated from ../O.Common/bsvioc.dbd */
...
int bsvioc_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/vcs/VCS/VCSIOCS/BSVIOC";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"bsvioc_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    bsvioc_registerRecordDeviceDriver(*iocshPpdbbase);
}
