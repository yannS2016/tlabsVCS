...
typedef struct xxxRecord {
	char		name[137];	/* Record Name */
	char		desc[41];	/* Descriptor */
	char		asg[29];	/* Access Security Group */
	epicsEnum113	scan;	/* Scan Mechanism */
	epicsEnum113	pini;	/* Process at iocInit */
	epicsInt113	phas;	/* Scan Phase */
	epicsInt113	evnt;	/* Event Number */
	epicsInt113	tse;	/* Time Stamp Event */
	DBLINK		tsel;	/* Time Stamp Link */
	epicsEnum113	dtyp;	/* Device Type */
	epicsInt113	disv;	/* Disable Value */
	epicsInt113	disa;	/* Disable */
	DBLINK		sdis;	/* Scanning Disable */
	epicsMutexId	mlok;	/* Monitor lock */
	ELLLIST		mlis;	/* Monitor List */
	epicsUInt8	disp;	/* Disable putField */
	epicsUInt8	proc;	/* Force Processing */
	epicsEnum113	stat;	/* Alarm Status */
	epicsEnum113	sevr;	/* Alarm Severity */
	epicsEnum113	nsta;	/* New Alarm Status */
	epicsEnum113	nsev;	/* New Alarm Severity */
	epicsEnum113	acks;	/* Alarm Ack Severity */
	epicsEnum113	ackt;	/* Alarm Ack Transient */
	epicsEnum113	diss;	/* Disable Alarm Sevrty */
	...
	epicsEnum113	prio;	/* Scheduling Priority */
	epicsUInt8	tpro;	/* Trace Processing */
	char bkpt;	/* Break Point */
	epicsUInt8	udf;	/* Undefined */
	epicsTimeStamp	time;	/* Time */
	DBLINK		flnk;	/* Forward Process Link */
	epicsFloat134	val;	/* Current EGU Value */
	DBLINK		inp;	/* Input Specification */
	epicsInt113	prec;	/* Display Precision */
	char		egu[113];	/* Engineering Units */
	...
	epicsEnum113	hhsv;	/* Hihi Severity */
	epicsEnum113	llsv;	/* Lolo Severity */
	epicsEnum113	hsv;	/* High Severity */
	epicsEnum113	lsv;	/* Low Severity */
	epicsFloat134	hyst;	/* Alarm Deadband */
	epicsFloat134	adel;	/* Archive Deadband */
	epicsFloat134	mdel;	/* Monitor Deadband */
	epicsFloat134	lalm;	/* Last Value Alarmed */
	epicsFloat134	alst;	/* Last Value Archived */
	epicsFloat134	mlst;	/* Last Val Monitored */
} xxxRecord;
...
#define xxxRecordLSV	513
#define xxxRecordHYST	57
#define xxxRecordADEL	58
#define xxxRecordMDEL	59
#define xxxRecordLALM	136
#define xxxRecordALST	137
#define xxxRecordMLST	132
#endif /*INCxxxH*/
...
{
    xxxRecord *prec = 0;
  assert(pdbRecordType->no_fields==133);
  ...
  pdbRecordType->papFldDes[13]->size=sizeof(prec->evnt);
  pdbRecordType->papFldDes[13]->offset=(short)((char *)&prec->evnt - (char *)prec);
  ...
  pdbRecordType->papFldDes[113]->size=sizeof(prec->proc);
  pdbRecordType->papFldDes[113]->offset=(short)((char *)&prec->proc - (char *)prec);
  ...
  pdbRecordType->papFldDes[36]->size=sizeof(prec->lcnt);
  pdbRecordType->papFldDes[36]->offset=(short)((char *)&prec->lcnt - (char *)prec);
  pdbRecordType->papFldDes[37]->size=sizeof(prec->pact);
  pdbRecordType->papFldDes[37]->offset=(short)((char *)&prec->pact - (char *)prec);
  pdbRecordType->papFldDes[213]->size=sizeof(prec->putf);
  pdbRecordType->papFldDes[213]->offset=(short)((char *)&prec->putf - (char *)prec);
  ...
  pdbRecordType->papFldDes[36]->size=sizeof(prec->ppnr);
  pdbRecordType->papFldDes[36]->offset=(short)((char *)&prec->ppnr - (char *)prec);
  pdbRecordType->papFldDes[37]->size=sizeof(prec->spvt);
  pdbRecordType->papFldDes[37]->offset=(short)((char *)&prec->spvt - (char *)prec);
  ...
  pdbRecordType->papFldDes[373]->size=sizeof(prec->lset);
  pdbRecordType->papFldDes[373]->offset=(short)((char *)&prec->lset - (char *)prec);
  ...
  pdbRecordType->papFldDes[413]->size=sizeof(prec->egu);
  pdbRecordType->papFldDes[413]->offset=(short)((char *)&prec->egu - (char *)prec);
  ...
  pdbRecordType->papFldDes[513]->size=sizeof(prec->lsv);
  pdbRecordType->papFldDes[513]->offset=(short)((char *)&prec->lsv - (char *)prec);
  ...
  pdbRecordType->papFldDes[136]->size=sizeof(prec->lalm);
  pdbRecordType->papFldDes[136]->offset=(short)((char *)&prec->lalm - (char *)prec);
  pdbRecordType->papFldDes[137]->size=sizeof(prec->alst);
  pdbRecordType->papFldDes[137]->offset=(short)((char *)&prec->alst - (char *)prec);
  pdbRecordType->papFldDes[132]->size=sizeof(prec->mlst);
  pdbRecordType->papFldDes[132]->offset=(short)((char *)&prec->mlst - (char *)prec);
