...
/* Generated from ../O.Common/a13aioc.dbd */
...
int a13aioc_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/vcs/VCS/VCSIOCS/A13AIOC";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"a13aioc_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    a13aioc_registerRecordDeviceDriver(*iocshPpdbbase);
}
