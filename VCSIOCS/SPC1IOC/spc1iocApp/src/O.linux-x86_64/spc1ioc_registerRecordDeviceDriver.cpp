...
/* Generated from ../O.Common/spc1ioc.dbd */
...
int spc1ioc_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/vcs/VCS/VCSIOCS/SPC1IOC";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"spc1ioc_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    spc1ioc_registerRecordDeviceDriver(*iocshPpdbbase);
}
