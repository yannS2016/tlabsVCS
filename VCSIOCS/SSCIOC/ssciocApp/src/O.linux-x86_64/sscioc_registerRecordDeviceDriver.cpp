...
/* Generated from ../O.Common/sscioc.dbd */
...
epicsShareExtern void (*pvar_func_ssclClearanceSNCRegistrar)(void);
...
int sscioc_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/vcs/VCS/VCSIOCS/SSCIOC";
    ...
    (*pvar_func_ssclClearanceSNCRegistrar)();
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"sscioc_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    sscioc_registerRecordDeviceDriver(*iocshPpdbbase);
}
