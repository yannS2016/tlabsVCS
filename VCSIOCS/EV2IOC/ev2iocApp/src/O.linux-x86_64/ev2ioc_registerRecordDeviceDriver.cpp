...
/* Generated from ../O.Common/ev2ioc.dbd */
...
int ev2ioc_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/vcs/VCS/VCSIOCS/EV2IOC";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"ev2ioc_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    ev2ioc_registerRecordDeviceDriver(*iocshPpdbbase);
}
