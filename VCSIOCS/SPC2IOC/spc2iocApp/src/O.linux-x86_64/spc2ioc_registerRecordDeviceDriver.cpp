...
/* Generated from ../O.Common/spc2ioc.dbd */
...
int spc2ioc_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/vcs/VCS/VCSIOCS/SPC2IOC";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"spc2ioc_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    spc2ioc_registerRecordDeviceDriver(*iocshPpdbbase);
}
