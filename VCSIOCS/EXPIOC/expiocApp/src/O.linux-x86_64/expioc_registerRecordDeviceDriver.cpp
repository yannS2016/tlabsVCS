...
/* Generated from ../O.Common/expioc.dbd */
...
int expioc_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/vcs/VCS/VCSIOCS/EXPIOC";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"expioc_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    expioc_registerRecordDeviceDriver(*iocshPpdbbase);
}
