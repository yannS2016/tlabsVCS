...
export ERROR="\033[33;1m"   # red output
...
cd ./dbd
#diff -u iocvcs.dbd iocvcs_new.dbd > iocvcs_dbd.patch cause subsequent cmd not to execute
patch -p0 -u -b < ./expioc_dbd.patch
cat expioc.dbd | grep "choice(menuScan"
