...
#define xxxRecordLCNT	38
#define xxxRecordPACT	39
#define xxxRecordPUTF	26
#define xxxRecordRPRO	27
#define xxxRecordASP	28
#define xxxRecordPPN	29
#define xxxRecordPPNR	38
#define xxxRecordSPVT	39
...
static int xxxRecordSizeOffset(dbRecordType *pdbRecordType)
{
  ...
  pdbRecordType->papFldDes[38]->size=sizeof(prec->lcnt);
  pdbRecordType->papFldDes[38]->offset=(short)((char *)&prec->lcnt - (char *)prec);
  pdbRecordType->papFldDes[39]->size=sizeof(prec->pact);
  pdbRecordType->papFldDes[39]->offset=(short)((char *)&prec->pact - (char *)prec);
  ...
  pdbRecordType->papFldDes[38]->size=sizeof(prec->ppnr);
  pdbRecordType->papFldDes[38]->offset=(short)((char *)&prec->ppnr - (char *)prec);
  pdbRecordType->papFldDes[39]->size=sizeof(prec->spvt);
  pdbRecordType->papFldDes[39]->offset=(short)((char *)&prec->spvt - (char *)prec);
