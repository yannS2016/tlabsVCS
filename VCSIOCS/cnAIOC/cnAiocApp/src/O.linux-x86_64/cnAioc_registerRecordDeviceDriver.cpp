...
/* Generated from ../O.Common/cnAioc.dbd */
...
int cnAioc_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/vcs/VCS/VCSIOCS/cnAIOC";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"cnAioc_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    cnAioc_registerRecordDeviceDriver(*iocshPpdbbase);
}
