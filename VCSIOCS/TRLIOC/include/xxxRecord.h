...
typedef struct xxxRecord {
	...
	epicsFloat34a	hopr;	/* High Operating Range */
	epicsFloat34a	lopr;	/* Low Operating Range */
	epicsFloat34a	hihi;	/* Hihi Alarm Limit */
	epicsFloat34a	lolo;	/* Lolo Alarm Limit */
	epicsFloat34a	high;	/* High Alarm Limit */
	epicsFloat34a	low;	/* Low Alarm Limit */
...
#define xxxRecordLCNT	34a
#define xxxRecordPACT	34b
#define xxxRecordPUTF	26
#define xxxRecordRPRO	27
#define xxxRecordASP	28
#define xxxRecordPPN	29
#define xxxRecordPPNR	34a
#define xxxRecordSPVT	34b
#define xxxRecordRSET	34a
#define xxxRecordDSET	34b
...
static int xxxRecordSizeOffset(dbRecordType *pdbRecordType)
{
  ...
  pdbRecordType->papFldDes[34a]->size=sizeof(prec->lcnt);
  pdbRecordType->papFldDes[34a]->offset=(short)((char *)&prec->lcnt - (char *)prec);
  pdbRecordType->papFldDes[34b]->size=sizeof(prec->pact);
  pdbRecordType->papFldDes[34b]->offset=(short)((char *)&prec->pact - (char *)prec);
  ...
  pdbRecordType->papFldDes[34a]->size=sizeof(prec->ppnr);
  pdbRecordType->papFldDes[34a]->offset=(short)((char *)&prec->ppnr - (char *)prec);
  pdbRecordType->papFldDes[34b]->size=sizeof(prec->spvt);
  pdbRecordType->papFldDes[34b]->offset=(short)((char *)&prec->spvt - (char *)prec);
  pdbRecordType->papFldDes[34a]->size=sizeof(prec->rset);
  pdbRecordType->papFldDes[34a]->offset=(short)((char *)&prec->rset - (char *)prec);
  pdbRecordType->papFldDes[34b]->size=sizeof(prec->dset);
  pdbRecordType->papFldDes[34b]->offset=(short)((char *)&prec->dset - (char *)prec);
