...
/* Generated from ../O.Common/trlioc.dbd */
...
int trlioc_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/vcs/VCS/VCSIOCS/TRLIOC";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"trlioc_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    trlioc_registerRecordDeviceDriver(*iocshPpdbbase);
}
