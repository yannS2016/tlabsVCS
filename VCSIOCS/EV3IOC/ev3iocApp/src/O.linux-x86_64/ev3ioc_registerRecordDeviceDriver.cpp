...
/* Generated from ../O.Common/ev3ioc.dbd */
...
int ev3ioc_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/vcs/VCS/VCSIOCS/EV3IOC";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"ev3ioc_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    ev3ioc_registerRecordDeviceDriver(*iocshPpdbbase);
}
