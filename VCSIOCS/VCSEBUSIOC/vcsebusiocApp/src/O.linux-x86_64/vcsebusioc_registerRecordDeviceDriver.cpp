...
/* Generated from ../O.Common/vcsebusioc.dbd */
...
int vcsebusioc_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/vcs/VCS/VCSIOCS/VCSEBUSIOC";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"vcsebusioc_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    vcsebusioc_registerRecordDeviceDriver(*iocshPpdbbase);
}
