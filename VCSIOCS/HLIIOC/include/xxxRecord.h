...
#define xxxRecordLCNT	30
#define xxxRecordPACT	31
...
static int xxxRecordSizeOffset(dbRecordType *pdbRecordType)
{
  ...
  pdbRecordType->papFldDes[30]->size=sizeof(prec->lcnt);
  pdbRecordType->papFldDes[30]->offset=(short)((char *)&prec->lcnt - (char *)prec);
  pdbRecordType->papFldDes[31]->size=sizeof(prec->pact);
  pdbRecordType->papFldDes[31]->offset=(short)((char *)&prec->pact - (char *)prec);
