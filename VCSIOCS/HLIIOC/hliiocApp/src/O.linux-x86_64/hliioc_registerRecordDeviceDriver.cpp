...
/* Generated from ../O.Common/hliioc.dbd */
...
int hliioc_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/vcs/VCS/VCSIOCS/HLIIOC";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"hliioc_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    hliioc_registerRecordDeviceDriver(*iocshPpdbbase);
}
