...
/* Generated from ../O.Common/ev1ioc.dbd */
...
int ev1ioc_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/vcs/VCS/VCSIOCS/EV1IOC";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"ev1ioc_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    ev1ioc_registerRecordDeviceDriver(*iocshPpdbbase);
}
