...
/* Generated from ../O.Common/speioc.dbd */
...
int speioc_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/vcs/VCS/VCSIOCS/SPEIOC";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"speioc_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    speioc_registerRecordDeviceDriver(*iocshPpdbbase);
}
